...
2.  代码测试
    ...
    ![](image/image_HasKvwKkFt.png)

    测试结果

    ![](image/image_rM7o5_JxMx.png)
3.  引入配置

    Logback要求配置文件名称必须是logback.xml，存放路径在main/resources目录下。

    ![](image/image_1yTJ2l_3CU.png)
...
![](image/image_CCXiQR1OtY.png)

![](image/image_KSrGd0biVQ.png)

![](image/image_PoEh-9GVrR.png)
...
![](image/image_8RlmGCLaBQ.png)

#### 1.3 **\${}形式**

\${}形式传参，底层Mybatis做的是字符串拼接操作。

![](image/image__ojXNgTyaD.png)
...
-   Mapper 配置文件放在 Mapper 接口所在的包内
    ...
    -   可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件
        ...
        ![](image/image_sYJdBGnrob.png)

        ![](image/image_LHdRXUdP5D.png)
...
2.  使用 IntelliJ IDEA连接数据库
    -   连接数据库
        ...
        ![](image/image_fm-MFSwW33.png)
    -   填写信息

        ![](image/image_c54BDsubkg.png)
    -   展示库表

        ![](image/image_7J4tAEH5JE.png)
    -   逆向工程使用

        ![](image/image_AohjPJQ-7l.png)

        ![](image/image_FIuODxPKf7.png)

        ![](image/image_uRRJaZzTo8.png)
3.  查看生成结果

    ![](image/image_xhjGu_4Ce4.png)
4.  逆向工程案例使用
