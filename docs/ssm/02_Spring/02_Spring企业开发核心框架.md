...
-   **1.1 什么是组件？**
    ...
    ![](image/image_aKpD34cBOJ.png)

    整个项目就是由各种组件搭建而成的：

    ![](image/image_Zv7aB3JB6r.png)
-   **1.2 我们的期待？**
    -   有人替我们创建组件的对象
    -   有人帮我们保存组件的对象
    -   有人帮助我们自动组装
...
![](image/image_VkV-uHK8KE.png)

对没实现接口的类应用切面

![](image/image_xH8Fl3WZWi.png)
