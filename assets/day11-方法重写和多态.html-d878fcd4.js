import{_ as n,o as s,c as a,e as p}from"./app-df909a29.js";const e={},t=p(`<h2 id="方法重写和多态" tabindex="-1"><a class="header-anchor" href="#方法重写和多态" aria-hidden="true">#</a> 方法重写和多态</h2><h3 id="_1-方法重写概念" tabindex="-1"><a class="header-anchor" href="#_1-方法重写概念" aria-hidden="true">#</a> 1. 方法重写概念</h3><blockquote><p>方法重写 Overrides 方法重载 Overload</p><p>1.存在于父子类之间(子类对父类的方法进行重写 必须有继承关系)</p><p>2.方法名称相同</p><p>3.参数列表相同</p><p>4.返回值相同(或者是其子类)</p><p>5.访问权限不能小于(严于)父类</p><p>6.静态方法可以继承 但是不能被重写</p><p>7.不能抛出、声明比父类更多的异常</p><p>@Override 注解表示子类重写父类的方法 可以提高代码的阅读性</p></blockquote><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>atguigu<span class="token punctuation">.</span>test1</span><span class="token punctuation">;</span>
