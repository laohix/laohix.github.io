import{_ as n,o as s,c as a,e as p}from"./app-df909a29.js";const t={},c=p(`<h2 id="jdk8新特性" tabindex="-1"><a class="header-anchor" href="#jdk8新特性" aria-hidden="true">#</a> JDK8新特性</h2><h3 id="_1-接口相关" tabindex="-1"><a class="header-anchor" href="#_1-接口相关" aria-hidden="true">#</a> 1.接口相关</h3><blockquote><p>在JDK8中接口中可以书写普通方法 和 静态方法</p><p>1.普通方法使用default来修饰</p><p>2.静态方法直接书写</p></blockquote><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
