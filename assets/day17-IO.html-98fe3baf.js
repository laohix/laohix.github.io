import{_ as n,o as s,c as a,e as t}from"./app-df909a29.js";const p={},e=t(`<h2 id="io" tabindex="-1"><a class="header-anchor" href="#io" aria-hidden="true">#</a> IO</h2><h3 id="_1-字节流" tabindex="-1"><a class="header-anchor" href="#_1-字节流" aria-hidden="true">#</a> 1. 字节流</h3><h4 id="_1-1-读-inputstream" tabindex="-1"><a class="header-anchor" href="#_1-1-读-inputstream" aria-hidden="true">#</a> 1.1 读(InputStream)</h4><ul><li>FileInputStream</li></ul><blockquote><p>InputStream</p><p>FileInputStream</p><p>FileInputStream(File file) 读取传入的File对象</p><p>FileInputStream(String fileName) 根据传入字符串读取文件</p><p>available() 获取当前字节读取流可读字节数</p><p>read() 每次读取一个字节 返回值为读取的内容 读取到文件末尾 返回值为-1</p><p>read(byte [] data) 每次读取一个字节数组 返回值为读取字节的个数 读取到文件末尾 返回值为-1</p></blockquote><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>atguigu<span class="token punctuation">.</span>test3</span><span class="token punctuation">;</span>
