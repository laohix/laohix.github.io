import{_ as n,o as s,c as a,e}from"./app-df909a29.js";const t="/assets/img001-4a454bc4.png",p="/assets/img002-209e7e81.png",i="/assets/img003-8bc632ed.png",c="/assets/img004-466f43af.png",l="/assets/img005-a419b3f2.png",o={},u=e(`<h1 id="今天目标" tabindex="-1"><a class="header-anchor" href="#今天目标" aria-hidden="true">#</a> 今天目标</h1><ul><li>ES6新语法： <ul><li>箭头函数： <ul><li>rest参数</li><li>spread参数</li></ul></li><li>创建类： <ul><li>class关键词</li><li>constructor关键词</li><li>get关键词</li><li>set关键词</li><li>声明私有属性</li></ul></li><li>多线程操作：使用Promise <ul><li>使用Promise执行异步操作</li><li>Promise异步操作成功之后怎么办？</li><li>Promise异步操作失败之后怎么办？</li><li>Promise对象的三个状态</li><li>如何解决回调地狱问题？</li></ul></li><li>模块化开发：代码的暴露和导入 <ul><li>分别导出</li><li>统一导出</li><li>默认导出</li></ul></li></ul></li><li>前端工程化环境搭建： <ul><li>Node.js</li><li>Vite</li></ul></li><li>Vue3初步使用</li></ul><h1 id="一、箭头函数" tabindex="-1"><a class="header-anchor" href="#一、箭头函数" aria-hidden="true">#</a> 一、箭头函数</h1><h2 id="_1、箭头函数和this的回顾" tabindex="-1"><a class="header-anchor" href="#_1、箭头函数和this的回顾" aria-hidden="true">#</a> 1、箭头函数和this的回顾</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">&gt;</span></span>
